...
java StupsCompiler -liveness tests/1.pas
...
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/2.pas
echo "# Calling jasmin.jar..."
...
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/3.pas
echo "# Calling jasmin.jar..."
...
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/4.pas
echo "# Calling jasmin.jar..."
...
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/5.pas
echo "# Calling jasmin.jar..."
...
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/6.pas
echo "# Calling jasmin.jar..."
...
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/7.pas
echo "# Calling jasmin.jar..."
...
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/8.pas
echo "# Calling jasmin.jar..."
...
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/9.pas
echo "# Calling jasmin.jar..."
...
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/10.pas
echo "# Calling jasmin.jar..."
...
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/11.pas
echo "# Calling jasmin.jar..."
...
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/12.pas
echo "# Calling jasmin.jar..."
...
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/13.pas
echo "# Calling jasmin.jar..."
...
echo "######################## Test 14 ########################"
echo "# Calling StupsCompiler - Compiling..."
java StupsCompiler -compile tests/14.pas
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/14.pas
echo "# Calling jasmin.jar..."
java -jar jasmin.jar tests/14.j
echo "# Executing Java File..."
java tests/14
echo "# Done."
echo "######################## Test 15 ########################"
echo "# Calling StupsCompiler - Compiling..."
java StupsCompiler -compile tests/15.pas
echo "# Calling StupsCompiler - Liveness Analysis..."
java StupsCompiler -liveness tests/15.pas
echo "# Calling jasmin.jar..."
