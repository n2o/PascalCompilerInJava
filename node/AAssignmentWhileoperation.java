...
public final class AAssignmentWhileoperation extends PWhileoperation
{
    private PAssignment _assignment_;

    public AAssignmentWhileoperation()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAssignmentWhileoperation(
    ...
    {
        ((Analysis) sw).caseAAssignmentWhileoperation(this);
    }
