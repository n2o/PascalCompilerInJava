...
public final class AOperationWhilenested extends PWhilenested
{
    private PWhileoperation _whileoperation_;

    public AOperationWhilenested()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOperationWhilenested(
    ...
    {
        ((Analysis) sw).caseAOperationWhilenested(this);
    }
