...
/*  {
        { // INITIAL
            ...
            {},
            {{61, 61, 62}, },
            {{48, 57, 53}, {65, 77, 54}, {78, 78, 63}, {79, 90, 54}, {95, 95, 55}, {97, 109, 56}, {110, 110, 64}, {111, 122, 56}, },
            {{48, 57, 53}, {65, 68, 54}, {69, 69, 65}, {70, 78, 54}, {79, 79, 66}, {80, 81, 54}, {82, 82, 67}, {83, 90, 54}, {95, 95, 55}, {97, 100, 56}, {101, 101, 68}, {102, 110, 56}, {111, 111, 69}, {112, 113, 56}, {114, 114, 70}, {115, 122, 56}, },
            {{48, 122, -7}, },
            {{48, 57, 53}, {65, 72, 54}, {73, 73, 71}, {74, 78, 54}, {79, 79, 72}, {80, 90, 54}, {95, 95, 55}, {97, 104, 56}, {105, 105, 73}, {106, 110, 56}, {111, 111, 74}, {112, 122, 56}, },
            {{48, 57, 53}, {65, 75, 54}, {76, 76, 75}, {77, 77, 54}, {78, 78, 76}, {79, 95, -23}, {97, 107, 56}, {108, 108, 77}, {109, 109, 56}, {110, 110, 78}, {111, 122, 56}, },
            {{48, 57, 53}, {65, 65, 79}, {66, 90, 54}, {95, 95, 55}, {97, 97, 80}, {98, 122, 56}, },
            {{48, 57, 53}, {65, 69, 54}, {70, 70, 81}, {71, 77, 54}, {78, 78, 82}, {79, 95, -23}, {97, 101, 56}, {102, 102, 83}, {103, 109, 56}, {110, 110, 84}, {111, 122, 56}, },
            {{48, 57, 53}, {65, 78, 54}, {79, 79, 85}, {80, 95, -26}, {97, 110, 56}, {111, 111, 86}, {112, 122, 56}, },
            {{48, 78, -30}, {79, 79, 87}, {80, 110, -30}, {111, 111, 88}, {112, 122, 56}, },
            {{48, 57, 53}, {65, 81, 54}, {82, 82, 89}, {83, 95, -24}, {97, 113, 56}, {114, 114, 90}, {115, 122, 56}, },
            {{48, 81, -32}, {82, 82, 91}, {83, 113, -32}, {114, 114, 92}, {115, 122, 56}, },
            {{48, 57, 53}, {65, 71, 54}, {72, 72, 93}, {73, 81, 54}, {82, 82, 94}, {83, 95, -24}, {97, 103, 56}, {104, 104, 95}, {105, 113, 56}, {114, 114, 96}, {115, 122, 56}, },
            {{48, 57, 53}, {65, 65, 97}, {66, 95, -28}, {97, 97, 98}, {98, 122, 56}, },
            {{48, 71, -34}, {72, 72, 99}, {73, 81, 54}, {82, 82, 100}, {83, 103, -34}, {104, 104, 101}, {105, 113, 56}, {114, 114, 102}, {115, 122, 56}, },
            {{48, 78, -30}, {79, 79, 103}, {80, 110, -30}, {111, 111, 104}, {112, 122, 56}, },
            {{48, 122, -7}, },
            {{48, 122, -23}, },
            {{48, 122, -24}, },
            {{48, 122, -7}, },
            ...
            {},
            {},
            {{48, 57, 53}, {65, 67, 54}, {68, 68, 116}, {69, 90, 54}, {95, 95, 55}, {97, 99, 56}, {100, 100, 117}, {101, 122, 56}, },
            {{48, 122, -65}, },
            {{48, 57, 53}, {65, 70, 54}, {71, 71, 118}, {72, 90, 54}, {95, 95, 55}, {97, 102, 56}, {103, 103, 119}, {104, 122, 56}, },
            {{48, 78, -30}, {79, 79, 120}, {80, 110, -30}, {111, 111, 121}, {112, 122, 56}, },
            {{48, 68, -24}, {69, 69, 122}, {70, 90, 54}, {95, 100, -24}, {101, 101, 123}, {102, 122, 56}, },
            {{48, 122, -67}, },
            {{48, 122, -68}, },
            {{48, 122, -69}, },
            {{48, 57, 53}, {65, 85, 54}, {86, 86, 124}, {87, 90, 54}, {95, 95, 55}, {97, 117, 56}, {118, 118, 125}, {119, 122, 56}, },
            {{48, 122, -7}, },
            {{48, 122, -73}, },
            {{48, 122, -7}, },
            {{48, 57, 53}, {65, 82, 54}, {83, 83, 126}, {84, 90, 54}, {95, 95, 55}, {97, 114, 56}, {115, 115, 127}, {116, 122, 56}, },
            {{48, 67, -65}, {68, 68, 128}, {69, 99, -65}, {100, 100, 129}, {101, 122, 56}, },
            {{48, 122, -77}, },
            {{48, 122, -78}, },
            {{48, 75, -27}, {76, 76, 130}, {77, 90, 54}, {95, 107, -27}, {108, 108, 131}, {109, 122, 56}, },
            {{48, 122, -81}, },
            {{48, 122, -7}, },
            {{48, 57, 53}, {65, 83, 54}, {84, 84, 132}, {85, 90, 54}, {95, 95, 55}, {97, 115, 56}, {116, 116, 133}, {117, 122, 56}, },
            {{48, 122, -7}, },
            {{48, 122, -84}, },
            {{48, 67, -65}, {68, 68, 134}, {69, 99, -65}, {100, 100, 135}, {101, 122, 56}, },
            {{48, 122, -87}, },
            {{48, 83, -84}, {84, 84, 136}, {85, 115, -84}, {116, 116, 137}, {117, 122, 56}, },
            {{48, 122, -89}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 78, -30}, {79, 79, 138}, {80, 110, -30}, {111, 111, 139}, {112, 122, 56}, },
            {{48, 122, -93}, },
            {{48, 68, -24}, {69, 69, 140}, {70, 100, -69}, {101, 101, 141}, {102, 122, 56}, },
            {{48, 57, 53}, {65, 84, 54}, {85, 85, 142}, {86, 90, 54}, {95, 95, 55}, {97, 116, 56}, {117, 117, 143}, {118, 122, 56}, },
            {{48, 122, -95}, },
            {{48, 122, -96}, },
            {{48, 81, -32}, {82, 82, 144}, {83, 113, -32}, {114, 114, 145}, {115, 122, 56}, },
            {{48, 122, -99}, },
            {{48, 72, -26}, {73, 73, 146}, {74, 90, 54}, {95, 104, -26}, {105, 105, 147}, {106, 122, 56}, },
            {{48, 72, -26}, {73, 73, 148}, {74, 104, -101}, {105, 105, 149}, {106, 122, 56}, },
            {{48, 122, -101}, },
            {{48, 122, -102}, },
            {{48, 81, -32}, {82, 82, 150}, {83, 113, -32}, {114, 114, 151}, {115, 122, 56}, },
            {{48, 122, -105}, },
            {{0, 127, -54}, },
            {{0, 127, -54}, },
            {{0, 127, -54}, },
            ...
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 72, -26}, {73, 73, 160}, {74, 104, -101}, {105, 105, 161}, {106, 122, 56}, },
            {{48, 122, -120}, },
            {{48, 75, -27}, {76, 76, 162}, {77, 107, -81}, {108, 108, 163}, {109, 122, 56}, },
            {{48, 122, -122}, },
            {{48, 57, 53}, {65, 65, 164}, {66, 95, -28}, {97, 97, 165}, {98, 122, 56}, },
            {{48, 122, -124}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 68, -24}, {69, 69, 166}, {70, 100, -69}, {101, 101, 167}, {102, 122, 56}, },
            {{48, 122, -128}, },
            {{46, 46, 168}, {48, 122, -7}, },
            {{46, 122, -130}, },
            {{48, 82, -77}, {83, 83, 169}, {84, 114, -77}, {115, 115, 170}, {116, 122, 56}, },
            {{48, 122, -132}, },
            {{48, 68, -24}, {69, 69, 171}, {70, 100, -69}, {101, 101, 172}, {102, 122, 56}, },
            {{48, 122, -134}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 70, -67}, {71, 71, 173}, {72, 102, -67}, {103, 103, 174}, {104, 122, 56}, },
            {{48, 122, -140}, },
            {{48, 77, -23}, {78, 78, 175}, {79, 109, -23}, {110, 110, 176}, {111, 122, 56}, },
            {{48, 122, -142}, },
            {{48, 68, -24}, {69, 69, 177}, {70, 100, -69}, {101, 101, 178}, {102, 122, 56}, },
            {{48, 122, -144}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 75, -27}, {76, 76, 179}, {77, 107, -81}, {108, 108, 180}, {109, 122, 56}, },
            {{48, 122, -148}, },
            {{48, 83, -84}, {84, 84, 181}, {85, 115, -84}, {116, 116, 182}, {117, 122, 56}, },
            {{48, 122, -150}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{0, 127, -116}, },
            ...
            {{0, 127, -59}, },
            {{48, 77, -23}, {78, 78, 187}, {79, 109, -23}, {110, 110, 188}, {111, 122, 56}, },
            {{48, 122, -162}, },
            {{48, 68, -24}, {69, 69, 189}, {70, 100, -69}, {101, 101, 190}, {102, 122, 56}, },
            {{48, 122, -164}, },
            {{48, 57, 53}, {65, 74, 54}, {75, 75, 191}, {76, 90, 54}, {95, 95, 55}, {97, 106, 56}, {107, 107, 192}, {108, 122, 56}, },
            {{48, 122, -166}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {},
            {{48, 68, -24}, {69, 69, 193}, {70, 100, -69}, {101, 101, 194}, {102, 122, 56}, },
            {{48, 122, -171}, },
            {{48, 70, -67}, {71, 71, 195}, {72, 102, -67}, {103, 103, 196}, {104, 122, 56}, },
            {{48, 122, -173}, },
            {{48, 81, -32}, {82, 82, 197}, {83, 113, -32}, {114, 114, 198}, {115, 122, 56}, },
            {{48, 122, -175}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 68, -24}, {69, 69, 199}, {70, 100, -69}, {101, 101, 200}, {102, 122, 56}, },
            {{48, 122, -181}, },
            {{48, 68, -24}, {69, 69, 201}, {70, 100, -69}, {101, 101, 202}, {102, 122, 56}, },
            {{48, 122, -183}, },
            {{0, 127, -157}, },
            {{0, 127, -157}, },
            ...
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 57, 53}, {65, 65, 204}, {66, 95, -28}, {97, 97, 205}, {98, 122, 56}, },
            {{48, 122, -191}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 68, -24}, {69, 69, 206}, {70, 100, -69}, {101, 101, 207}, {102, 122, 56}, },
            {{48, 122, -197}, },
            {{48, 57, 53}, {65, 65, 208}, {66, 95, -28}, {97, 97, 209}, {98, 122, 56}, },
            {{48, 122, -199}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 75, -27}, {76, 76, 210}, {77, 107, -81}, {108, 108, 211}, {109, 122, 56}, },
            {{48, 122, -203}, },
            {{0, 127, -117}, },
            {{48, 77, -23}, {78, 78, 212}, {79, 109, -23}, {110, 110, 213}, {111, 122, 56}, },
            {{48, 122, -206}, },
            {{48, 81, -32}, {82, 82, 214}, {83, 113, -32}, {114, 114, 215}, {115, 122, 56}, },
            {{48, 122, -208}, },
            {{48, 57, 53}, {65, 76, 54}, {77, 77, 216}, {78, 90, 54}, {95, 95, 55}, {97, 108, 56}, {109, 109, 217}, {110, 122, 56}, },
            {{48, 122, -210}, },
            {{48, 77, -23}, {78, 78, 218}, {79, 109, -23}, {110, 110, 219}, {111, 122, 56}, },
            {{48, 122, -212}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
            {{48, 122, -7}, },
...
/*  {
        // INITIAL
        {39, 39, 39, 39, 39, 40, 16, 17, 20, 18, 38, 19, 37, -1, 3, 3, 35, 36, 22, 21, 23, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, -1, 40, 40, 40, 40, 39, 3, 4, 24, 26, 25, 40, 40, 40, 40, 40, 40, 40, 40, 40, 13, 40, 13, 40, 40, 40, 40, 40, 40, 9, 40, 9, 40, 40, 40, 40, 40, 31, 31, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, -1, -1, -1, -1, -1, 39, 39, 39, 39, 39, 39, 29, 29, 40, 40, 40, 40, 40, 40, 27, 27, 40, 40, 7, 7, 40, 40, 40, 40, 28, 28, 32, 32, 40, 40, 40, 40, 40, 40, 2, 2, 40, 40, 40, 40, 30, 30, 39, 39, 39, 39, 39, 39, 39, 39, 40, 40, 40, 40, 40, 40, 11, 11, 6, 40, 40, 40, 40, 40, 40, 10, 10, 33, 33, 40, 40, 40, 40, 39, 39, -1, 39, 5, 5, 40, 40, 15, 15, 34, 34, 40, 40, 40, 40, 12, 12, 40, 40, 39, 40, 40, 40, 40, 40, 40, 40, 40, 1, 1, 0, 0, 8, 8, 14, 14, },
